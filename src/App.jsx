      ...
      <main className="relative z-10">
        ...
        <section className="pt-40 pb-20 px-6 max-w-7xl mx-auto min-h-[90vh] flex flex-col justify-center">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative w-full aspect-square md:aspect-[4/3] border border-cyan-900/50 bg-[#050508] p-1 flex flex-col shadow-[0_0_50px_rgba(0,255,255,0.05)]">
              ...
              <div className="flex-1 bg-black p-6 flex flex-col justify-between overflow-hidden relative">
                ...
                <div className="flex justify-between items-start mb-8 border-b border-cyan-900/50 pb-4">
                  <div>
                    ...
                    <div className="text-sm text-white transition-opacity duration-300">{glitchText}</div>
                  </div>
                ...
                <div className="flex-1 flex items-center justify-center relative">
                  <div className="absolute w-64 h-64 border border-cyan-900/30 rounded-full animate-[spin_10s_linear_infinite]"></div>
                  <div className="absolute w-48 h-48 border border-dashed border-cyan-800/50 rounded-full animate-[spin_15s_linear_infinite_reverse]"></div>
                  <div className="w-32 h-32 rounded-full bg-cyan-900/20 backdrop-blur-md border border-cyan-500/30 flex items-center justify-center shadow-[0_0_40px_rgba(0,255,255,0.1)]">
                    <EyeScannerIcon className="w-12 h-12 text-cyan-400" />
                  </div>
                </div>

                {/* System Diagnostics */}
                <div className="grid grid-cols-2 gap-4 mt-8">
                  <div className="border border-cyan-900/30 bg-cyan-900/10 p-3">
                    ...
                    <div className="w-full bg-cyan-950 h-1 mt-2"><div className="w-1/4 h-full bg-rose-500"></div></div>
                  </div>
                  <div className="border border-cyan-900/30 bg-cyan-900/10 p-3">
                    ...
                    <div className="w-full bg-cyan-950 h-1 mt-2"><div className="w-full h-full bg-cyan-500"></div></div>
                  </div>
                </div>
        ...
        <section className="py-24 border-y border-zinc-900 bg-[#030303]">
          <div className="max-w-4xl mx-auto px-6">
            ...
            <div className="space-y-12 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-cyan-900/50 before:to-transparent">
              ...
              <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
                <div className="flex items-center justify-center w-10 h-10 rounded-full border border-cyan-500 bg-black text-cyan-400 shrink-0 md:order-1 md:group-odd:-translate-x-1/2 md:group-even:translate-x-1/2 shadow-[0_0_15px_rgba(0,255,255,0.2)] z-10">
                  <span className="text-sm font-bold">1</span>
                </div>
                <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] p-6 bg-zinc-900/50 border border-zinc-800 backdrop-blur-sm">
              ...
              <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group">
                <div className="flex items-center justify-center w-10 h-10 rounded-full border border-zinc-700 bg-black text-zinc-500 shrink-0 md:order-1 md:group-odd:-translate-x-1/2 md:group-even:translate-x-1/2 z-10">
                  <span className="text-sm font-bold">2</span>
                </div>
                <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] p-6 bg-zinc-950/50 border border-zinc-900 backdrop-blur-sm opacity-50">
